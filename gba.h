...
/* An unsigned 8-bit (1-byte) type. Note that this type cannot be
written onto RAM directly. */
...
#define KEY_JUST_RELEASED(key, buttons, oldbuttons) ((KEY_DOWN(key, oldbuttons)) & (!(KEY_DOWN(key, buttons))))
